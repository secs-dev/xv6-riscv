...
- Цвет означает количество баллов и сложность. Серый -- тривиально (0 баллов).
  По возрастанию сложности: серый, зеленый, желтый, красный.

- Стрелки показывают зависимости между этапами. Вы можете выполнять их в любом
  порядке, но мы рекомендуем именно этот.
