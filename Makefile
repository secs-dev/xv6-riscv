...
$U/new.o: $U/new.cpp
	$(CXX) $(CXXFLAGS) -c -o $U/new.o $U/new.cpp
...
$U/pingpong.o: $U/pingpong.cpp 
	$(CXX) $(CXXFLAGS) -c -o $U/pingpong.cpp.o $U/pingpong.cpp
	$(LD) $(LDFLAGS) -N -e main -Ttext 0 -r $U/pingpong.cpp.o -o $U/pingpong.o
