...
Ещё хуже обстоит дело в самом типичном сценарии использования `fork`:
...
Переходим к самой важной части — копированию. Давайте теперь запретим запись как в страницы родительского, так и в страницы дочернего процесса в uvmcopy. Назовём такие страницы заблокированными.
